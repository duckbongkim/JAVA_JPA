...
public class ChildPersonality {
    ...
    public void addPersonalityToChild(Long childID, String personalityName){
        ...
        Personality personality = personalityRepository.findByPersonalityName(personalityName).
                orElseGet(()->personalityRepository.save(new Personality(personalityName)));
